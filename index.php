...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KMRZLCP"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->

	<?php
		include_once($g."_header.php");
		include_once($g."eyecatch.php");
		include_once($g."about.php");
		include_once($g."attitude.php");
		include_once($g."works.php");
//		include_once($g."baselink.php");
		include_once($g."illust.php");
